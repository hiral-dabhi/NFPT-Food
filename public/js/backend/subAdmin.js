...
var subAdmin = function () {
    ...
    var createSubAdminValidation = function () {
        var userRole = "{{getCurrentUserRoleName()}}";
        $('.sub-admin-create-form').validate({
            rules: {
                name: "required",
                email: {
                    required: true,
    ...
    var editSubAdminValidation = function () {
        $('.sub-admin-edit-form').validate({
            rules: {
                name: "required",
                email: {
                    required: true,
