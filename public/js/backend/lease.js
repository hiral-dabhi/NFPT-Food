"use strict";
var lease = function () {
    var createLeaseValidation = function () {
        ...
        $(".lease-create-form").validate({
            rules: validationRuless,
            messages: {
                name: {
    ...
    var changePassword = function () {
        ...
        $(document).on("change", ".ckb-portal-password", function () {
            if ($(this).prop("checked")) {
                $("#portal_password").prop("disabled", false).removeClass("disabled");
            } else {
                $('#portal_password').val('');
                $('#portal_password').prop('disabled', true).addClass("disabled");
            }
        });
    };
            ...
            $form.validate({
                ...
                messages: {
                    document_file: {
                        ...
                        editExtension: "Please upload a valid file (png, jpg, jpeg, pdf)",
                    },
                },
            });
            if ($form.valid()) {
        ...
        $(".lease-service").validate({
            rules: {
                ...
                ipv6_pool: {
                    required: {
                        depends: function (element) {
                            return $('.ckb-prefix-enable').is(':checked');
                        }
                    },
                ...
                ipv6_pool_delegation: {
                    required: {
                        depends: function (element) {
                            return $('.ckb-prefix-delegation-enable').is(':checked');
                        }
                    },
            ...
            messages: {
                ...
                concurrent_user: {
                    required: "Please select Concurrent User"
                },
                ipv4_mode: {
    ...
    var userType = function () {
        ...
        //     $('.portal-div').toggleClass('hidden', userTypeValue !== '0' && userTypeValue !== '1');        
        //     $('.username-div').toggleClass('hidden', userTypeValue !== '0');
        //     $('.mac-address-div').toggleClass('hidden', userTypeValue !== '1');
        // });
    ...
    var prefixEnable = function () {
        ...
        $('[name="ipv4_mode"]').on('click', function () {
            ...
            if (clickedValue == '1') {
                ...
                $('#ipv4_static_pool').rules('add', {
                    required: true
                });
                $('#ipv4_static_ip').rules('add', {
                    required: true
                });
                $('#ipv4_expirydate').rules('add', {
                    required: true
                });
                $('#ipv4_dhcp_pool').rules('add', {
                    required: false
                });
    ...
    var addScheduleValidation = function () {
        $(".add-schedule").validate({
            ...
            messages: {
                ...
                schedule_date: {
                    required: "Please enter data rate",
        ...
        function getIp(id) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    selectElement.empty();
                    selectElement.append('<option value="">Select Static IP</option>');
    ...
    var scheduleInit = function () {
        $('#lease-schedule-table').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            order: [
    ...
    var creditValidation = function () {
        ...
        $(".add-credit").validate({
            rules: {
                ...
                payment_mode: {
                    required: {
                        depends: function (element) {
                            return $('input[name="is_paid"]:checked').val() === '1';
                        },
                    },
                },
            },
        ...
        $(document).on('change', '.ckb-manual_unit_enable', function () {
            ...
            if ($(this).prop("checked")) {
                $manualUnitPrice.prop("disabled", false).removeClass("disabled");
            } else {
                $manualUnitPrice.val('0').prop('disabled', true).addClass("disabled");
