...
<html lang="en">
   <head>
      ...
      <title>Eatsie - Pick Up & Delivery Food Template</title>
      <!-- Bootstrap core CSS -->
         ...
         <div class="container">
            ...
            <a href="#" class="ms-3 text-left d-flex text-dark align-items-center gap-2 text-decoration-none bg-white border-0 me-auto" data-bs-toggle="modal" data-bs-target="#add-delivery-location">
               ...
               <span>
                  ...
                  <div class="small text-success">Sant Pura, Industrial Area...<i class="bi bi-arrow-right-circle-fill ms-1"></i></div>
               </span>
            </a>
         ...
         <div class="container">
            <div class="row py-3">
               <div class="d-flex gap-3 align-items-center">
                  {{-- <img src="{{asset('front/assets/img/fav.png')}}" class="img-fluid d-none d-md-block h-40">
                  ...
                  <a href="#app-section" class="text-nowrap ms-auto text-decoration-none d-flex align-items-center text-success border-0 btn btn-light rounded-pill">Download <span class="ms-1 d-none d-md-block"> Eatsie App Now&nbsp;</span><span><i class="bi bi-chevron-right text-success"></i></span></a> --}}
               </div>
            </div>
         </div>
      </section>
      ...
      {{-- <section class="main-banner bg-white pt-4">
         <div class="container">
            <div id="carouselExampleFade" class="carousel slide carousel-fade mb-4" data-bs-ride="carousel">
               <div class="carousel-inner rounded">
                  <div class="carousel-item active">
                     <a href="listing.html"><img src="{{asset('front/assets/img/banner1.png')}}" class="d-block w-100" alt="..."></a>
                  </div>
                  <div class="carousel-item">
                     <a href="packages.html"><img src="{{asset('front/assets/img/banner2.png')}}" class="d-block w-100" alt="..."></a>
                  </div>
               </div>
            ...
            <div class="row row-cols-2 row-cols-md-4 row-cols-lg-4 g-4">
               <div class="col"><a href="listing.html"><img src="{{asset('front/assets/img/l1.png')}}" alt="#" class="img-fluid rounded-3"></a></div>
               <div class="col"><a href="packages.html"><img src="{{asset('front/assets/img/l3.png')}}" alt="#" class="img-fluid rounded-3"></a></div>
               <div class="col"><a href="listing.html"><img src="{{asset('front/assets/img/l4.png')}}" alt="#" class="img-fluid rounded-3"></a></div>
               <div class="col"><a href="listing.html"><img src="{{asset('front/assets/img/l2.png')}}" alt="#" class="img-fluid rounded-3"></a></div>
            </div>
         </div>
      </section>
      <section class="bg-white">
         <div class="container py-5">
            ...
            <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-4 homepage-products-range">
               ...
               <div class="col">
                  <div class="text-center position-relative border rounded pb-4">
                     <img src="{{asset('front/assets/img/10.png')}}" class="img-fluid rounded-3 p-3" alt="...">
                     <div class="listing-card-body pt-0">
               ...
               <div class="col">
                  <div class="text-center position-relative border rounded pb-4">
                     <img src="{{asset('front/assets/img/11.png')}}" class="img-fluid rounded-3 p-3" alt="...">
                     <div class="listing-card-body pt-0">
               ...
               <div class="col">
                  <div class="text-center position-relative border rounded pb-4">
                     <img src="{{asset('front/assets/img/12.png')}}" class="img-fluid rounded-3 p-3" alt="...">
                     <div class="listing-card-body pt-0">
         ...
         <div class="container">
            <div class="row g-4">
               <div class="col-md-3 col-6">
                  <a href="listing.html"><img src="{{asset('front/assets/img/slider1.jpg')}}" class="img-fluid rounded-3"></a>
               </div>
               <div class="col-md-3 col-6">
                  <a href="listing.html"><img src="{{asset('front/assets/img/slider2.jpg')}}" class="img-fluid rounded-3"></a>
               </div>
               <div class="col-md-3 col-6">
                  <a href="listing.html"><img src="{{asset('front/assets/img/slider3.jpg')}}" class="img-fluid rounded-3"></a>
               </div>
               <div class="col-md-3 col-6">
                  <a href="listing.html"><img src="{{asset('front/assets/img/slider4.jpg')}}" class="img-fluid rounded-3"></a>
               </div>
            </div>
         </div>
      </section>
               ...
               <div class="row justify-content-center align-items-center app-2 px-lg-4">
                  <div class="col-md-7 px-lg-5">
                     <div class="text-md-start text-center">
                        ...
                        <div class="m-0 text-muted">We will send you a link, open it on your phone to download the app</div>
                     </div>
                     <div class="my-4 me-lg-5">
                        <div class="input-group bg-white shadow-sm rounded-pill p-2">
                           ...
                           <input type="text" class="form-control bg-white border-0 ps-0 me-1" placeholder="Enter phone number">
                           <button class="btn btn-warning rounded-pill py-2 px-4 border-0" type="button">Send app link</button>
                        </div>
                     </div>
                     <div class="text-md-start text-center mt-5 mt-md-1 pb-md-4 pb-lg-5">
                        <p class="mb-3">Download app from</p>
                        <a href="#/"><img alt="#" src="{{asset('front/assets/img/play-store')}}.svg" class="img-fluid mobile-app-icon"></a>
                        <a href="#/"><img alt="#" src="{{asset('front/assets/img/app-store')}}.svg" class="img-fluid mobile-app-icon"></a>
                     </div>
                  </div>
         ...
         <div class="container">
            ...
            <div class="row text-white mt-5">
               <div class="col-md-4 col-12">
                  <div><img src="{{asset('front/assets/img/fav.png')}}" alt="" class="img-fluid footer-logo"></div>
               </div>
               <div class="col-md-2 col-6">
                  <h6 class="text-uppercase mb-4 fw-bold">Eatsie</h6>
               ...
               <div class="col-md-2 col-6">
                  ...
                  <ul class="list-unstyled d-grid gap-2">
                     ...
                     <li><a class="text-decoration-none text-white-50" href="profile.html">Eatsie Cash</a></li>
            ...
            <div class="modal-content border-0 shadow">
               ...
               <div class="modal-body p-4">
                  <div class="text-center mb-5 pb-2">
                     <div class="mb-3"><img src="{{asset('front/assets/img/login2.png')}}" class="col-6 mx-auto" alt="" ></div>
                  ...
                  <form>
                     ...
                     <div class="input-group mb-2 border rounded-3 p-1">
                        ...
                        <input type="text" class="form-control border-0 bg-white ps-1" placeholder="Enter the code" aria-label="Username" aria-describedby="basic-addon1">
                     </div>
                  </form>
               </div>
               <div class="modal-footer px-4 pb-4 pt-0 border-0">
                  <button class="btn btn-success btn-lg py-3 px-4 text-uppercase  w-100 m-0" data-bs-target="#exampleModalToggle4" data-bs-toggle="modal">Claim Eatsie Cash</button>
               </div>
            </div>
         </div>
      </div>
               ...
               <div class="modal-body p-4">
                  <div class="row justify-content-center">
                     <div class="col-10 text-center">
                        <div class="mb-5"><img src="{{asset('front/assets/img/login3.png')}}" alt="" class="col-6 mx-auto"></div>
                        <div class="my-3">
         ...
         <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
               ...
               <div class="modal-body p-4">
                  ...
                  <div>
                     <div data-bs-dismiss="modal" aria-label="Close" class="d-flex align-items-center gap-3 border-bottom py-3">
