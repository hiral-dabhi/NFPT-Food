    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-12 text-white">
                ...
                <p class="text-white-50 m-0">Living in the city, there is never enough time to shop for groceries,
                    ...
                    doorstep. From any store to your door, just make a list and we’ll make it disappear. Just Eatsie It!
                </p>
            </div>
        </div>
        <hr class="text-white">
        {{-- <div class="row text-white mt-5">
            <div class="col-md-4 col-12">
                <div><img src="{{ asset('front/assets/img/fav.png') }}" alt="" class="img-fluid footer-logo">
                </div>
            </div>
            ...
            <div class="col-md-2 col-6">
                ...
                <ul class="list-unstyled d-grid gap-2">
                    ...
                    <li><a class="text-decoration-none text-white-50" href="listing-detail.html">Listing Detail</a>
                    </li>
                    <li><a class="text-decoration-none text-white-50" href="product-detail.html">Product Detail</a>
                    </li>
