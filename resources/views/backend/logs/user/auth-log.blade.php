                ...
                <div class="flex flex-wrap card-body">
                    <div class="nav-tabs border-b-tabs">
                        <ul
                            ...
                            <li>
                                <a href="{{ route('logs.user.auth') }}" class="inline-block p-4 active">AuthLog</a>
                            </li>
                            <li>
                                <a href="{{ route('logs.user.cts') }}" class="inline-block p-4">CTS/NAT</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                                ...
                                <div class="grid grid-cols-12 gap-x-3 gap-y-3">
                                    ...
                                    <div class="col-span-12 lg:col-span-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="macaddress" id="macaddress" placeholder="MAC Address"
                                                class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100"
                                    ...
                                    <div class="col-span-12 lg:col-span-3">
                                        <div class="mb-3">
                                            <div class="mb-2">
                                                <label for="status"
                                                    class="font-medium text-gray-500 form-label text-13 dark:text-zinc-100">Status:</label>
                                            </div>
                                    ...
                                    <div class="col-span-12 lg:col-span-3">
                                        <div class="mb-3">
                                            <div class="mb-2">
                                                <label for="message"
                                                    class="font-medium text-gray-500 form-label text-13 dark:text-zinc-100">Message:</label>
                                            </div>
                                            <input type="text" name="message" id="message" placeholder="Reply Message"
                                                class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100"
                                                value="{{ old('message') }}">
                                        </div>
                                    </div>
                            ...
                            <div class="relative overflow-x-auto card-body">
                                ...
                                <table id="user-auth-log-table" class="table w-full pt-4 text-gray-700 dark:text-zinc-100">
                                    <thead>
                                        <tr>
                                            <th
