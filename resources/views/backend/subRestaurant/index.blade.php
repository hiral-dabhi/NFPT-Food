                    ...
                    <div class="col-span-12">
                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                            <div class="relative overflow-x-auto card-body">
                                <table id="sub-restaurant-table" class="table w-full pt-4 text-gray-700 dark:text-zinc-100"
                                    id="sub-restaurant-table" aria-label="table">
                                    <thead>
                                        <tr>
...
@section('scripts')
    ...
    <script>
        var getlist = "{{ route('subRestaurant.fetch') }}";
    </script>
