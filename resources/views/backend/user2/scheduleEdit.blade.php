    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Schedule Edit" pagetitle="Users" />
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">                            
                            <div class="relative overflow-x-auto card-body">
                                <form class="update-schedule" id="update_schedule"
                                    action="{{ route('user.schedule.update', $userSchedule->id) }}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-span-6">
                                            <div class="mb-4 grid grid-cols-6">
                                                <label class="col-span-2 font-medium text-gray-700 dark:text-gray-100"><b>User
                                                        Name</b></label>
                                                <span
                                                    class="col-span-4 font-medium text-gray-700 dark:text-gray-100">{{ $user->username ?? '--' }}</span>
                                            </div>
