                    ...
                    <div class="col-span-12">
                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                                        ...
                                        <ul class="flex flex-wrap">
                                            <li class="nav-item">
                                                <a class="px-4 py-2 text-gray-600 nav-link text-16 dark:text-gray-100"
                                                    href="{{ route('user.index') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    aria-label="Grid"><i class="bx bx-grid-alt"></i></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="px-4 py-2 text-white rounded nav-link active bg-violet-500 text-16"
                                                    href="{{ route('user.index.list') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="relative overflow-x-auto card-body">
                                <table id="user-table" class="table w-full pt-4 text-gray-700 dark:text-zinc-100" aria-label="table">
                                    <thead>
                                        <tr>
