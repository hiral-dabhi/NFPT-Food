    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Create Card" pagetitle="Card" />

                <div class="grid grid-cols-1 mt-3">
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <form method="POST" action="{{ route('cards.store') }}" class="card-create-form">
                            @csrf
                            <div class="bg-white sm:p-6 shadow sm:rounded-md">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        <label for="quantity"
                                            class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Quantity<span
                                                class="text-sm text-red-600">*</span></label>
                                        <input type="number" name="quantity" id="quantity" placeholder="Card's Quantity"
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        <label for="valid_till"
                                            class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Valid Till<span class="text-sm text-red-600">*</span></label>
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        <label for="prefix"
                                            class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Prefix</label>
                                        <input type="text" name="prefix" id="prefix" placeholder="Prefix Of UserName (MAX 2 character)"
                                            class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100"
                                            value="{{ old('prefix') }}">
                                        @error('prefix')
                                            <p class="text-sm text-red-600">{{ $message }}</p>
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        <label for="verification"
                                            class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Verification<span class="text-sm text-red-600">*</span></label>
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        <label for="service_id"
                                            class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Service<span class="text-sm text-red-600">*</span></label>
                                        <select name="service_id" id="service_id"
                                            class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100">
                                            <option value="">Select Service</option>
                                            @foreach ($cardServiceslist as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('service_id') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('service_id')
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        <label for="concurrent_user"
                                            class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Concurrent User<span
                                                class="text-sm text-red-600">*</span></label>
                                        <input type="number" name="concurrent_user" id="concurrent_user" placeholder="Enter concurrent_user"
                                            class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100"
                                            value="{{ old('concurrent_user', 1) }}">
