    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Edit Email Notification" pagetitle="Email Notification" />

                <div class="grid grid-cols-1">
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <form method="POST" action="{{ route('email-notification.update', $email) }}"
                            class="email-notification-edit-form">
                            @csrf
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <input type="text" name="title" id="title" placeholder="Enter title"
                                            ...
                                            value="{{ old('title', $email->title) }}" readonly>
                                        @error('title')
                                        ...
                                        <div class="mt-1 flex items-center">
                                            <div class="flex items-center" style="margin-right: 10px">
                                                <input type="radio" id="status1" name="status" value="1"
                                                    {{ old('status', $email->status) == '1' ? 'checked' : '' }}
                                            ...
                                            <div class="flex items-center">
                                                <input type="radio" id="status2" name="status" value="0"
                                                    {{ old('status', $email->status) == '0' ? 'checked' : '' }}
                                                    class="form-radio h-4 w-4 text-indigo-600 transition duration-150 ease-in-out">
                                                <label for="status2"
                                    ...
                                    <div class="col-span-6 sm:col-span-4 flex items-center justify-center">
                                        ...
                                        <a class="font-medium text-white border-transparent btn bg-red-500 w-28 hover:bg-red-700 focus:bg-red-700 focus:ring focus:ring-red-50"
                                            href="{{ route('email-notification.index') }}">
                                            Back
                                        </a>
                                    </div>
