    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Schedules" pagetitle="Users" />
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                                        ...
                                        <ul
                                            ...
                                            <li>
                                                <a href="javascript:void(0)"
                                                    class="inline-block p-4 schedule-status active" id="pending" data-status="0">Pending</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0)"
                                                    class="inline-block p-4 schedule-status" id="history" data-status="1">History</a>
                                            </li>
                            ...
                            <div class="relative overflow-x-auto card-body">
                                <table id="user-schedule-table" class="table w-full pt-4 text-gray-700 dark:text-zinc-100"
                                    aria-label="table">
                                    <thead>
                                        <tr>
                                            <th
...
@section('scripts')
    ...
    <script>
        var userId = "{{ $user->id }}";
        var getSchedulelist = "{{ route('user.schedule.fetch') }}";
    </script>
