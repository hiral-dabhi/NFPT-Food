...
@section('title')
    {{ __('Edit NFPT Business Approval Team') }}
@endsection
@section('css')
    <!-- alertifyjs Css -->
    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Edit NFPT Business Approval Team" pagetitle="NFPT Business Approval Team" />

                <div class="grid grid-cols-1 mt-3">
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body">
                            <form method="POST" action="{{ route('subAdmin.update', $user->id) }}"
                                class="sub-admin-edit-form" id="subAdmin_form_edit">
                                @csrf
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="firstname" id="firstname" placeholder="Enter First Name"
                                                ...
                                                value="{{ old('firstname', isset($user->firstname) && !empty($user->firstname) ? Crypt::decryptString($user->firstname) : '') }}">
                                            @error('firstname')
