<div class="relative z-50 hidden modal" id="re-solved-modal" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="bg-white dark:bg-zinc-700">
                    ...
                    <div class="modal">
                        <div class="px-5 py-3 border-b modal-body border-gray-50 dark:border-zinc-600">
                            <h3 class="text-gray-700 dark:text-gray-100">Ticket Resolve</h3>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="{{ route('tickets.list.re-solved', $ticket) }}" class="ticket-re-solved-form" enctype="multipart/form-data">
                                @csrf
                                <div class="bg-white sm:p-6 shadow sm:rounded-md">
                                    <div class="grid grid-cols-3 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-4 flex items-center justify-center">
                                            <button type="submit" class="text-white btn bg-green-500 border-black-500 hover:bg-green-600 focus:ring ring-green-50 focus:bg-green-600">Re-Solved</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
