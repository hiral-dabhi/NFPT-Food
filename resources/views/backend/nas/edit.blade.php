    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Edit NAS" pagetitle="NAS" />

                <div class="grid grid-cols-1 mt-3">
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <form method="POST" action="{{ route('nas.update', $nas->id) }}" class="nas-edit-form"
                            id="nas_edit_form">
                            @csrf
                            <div class="card-body">
                                <div class="grid grid-cols-12 gap-x-6">
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="short_name" id="short_name"
                                                    value="{{ old('short_name', $nas->shortname ?? '') }}"
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="ip_address" id="ip_address"
                                                    value="{{ old('ip_address', $nas->nasname ?? '') }}"
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="coa_port" id="coa_port"
                                                    value="{{ old('coa_port', $nas->coaport ?? '') }}"
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <label class="block text-sm font-medium text-red-700">For Monitoring (Only work
                                            with
                                            Mikrotik NAS
                                            Type)</label>
                                        <div class="hidden sm:block">
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="api_username" id="api_username"
                                                    value="{{ old('api_username', $nas->api_username ?? '') }}"
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="api_port" id="api_port"
                                                    value="{{ old('api_port', $nas->api_port ?? '') }}"
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                <label for="wan_interface"
                                                    class="block text-sm font-medium text-gray-700">Interface 1</label>
                                                <input type="text" name="wan_interface" id="wan_interface"
                                                    value="{{ old('wan_interface', $nas->wan_interface ?? '') }}"
                                                    placeholder="Enter interface 1"
                                                    class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100"
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                <label for="lan_interface"
                                                    class="block text-sm font-medium text-gray-700">Interface 2</label>
                                                <input type="text" name="lan_interface" id="lan_interface"
                                                    value="{{ old('lan_interface', $nas->lan_interface ?? '') }}"
                                                    placeholder="Enter interface 2"
                                                    class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100">
                                                @error('lan_interface')
                                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                                @enderror
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="lan_ip_pool" id="lan_ip_pool"
                                                    value="{{ old('lan_ip_pool', $nas->lan_ippool ?? '') }}"
                                    ...
                                    <div class="col-span-12 lg:col-span-6 mt-5">
                                        <label class="block text-sm font-medium text-red-700">For CTS/NAT logs</label>
                                        <div class="hidden sm:block">
                                            <div class="py-2">
                                                <div class="border-t border-gray-200"></div>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="prefix_directory" id="prefix_directory"
                                                    ...
                                                    class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100"
                                                    value="{{ old('prefix_directory', $nas->logsrv_prefix ?? '') }}">
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-6">
                                                <div style="display: flex; align-items: center;">
                                                    <input type="checkbox"
                                                        ...
                                                        name="block_unwanted" value="1"
                                                        {{ old('block_unwanted', $nas->block_unwanted_req == 1 ? 'checked' : '') }}>
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="blocked_ip_pool" id="blocked_ip_pool"
                                                    value="{{ old('blocked_ip_pool', $nas->blocked_ippool ?? '') }}"
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                ...
                                                <input type="text" name="blocked_address_list"
                                                    id="blocked_address_list"
                                                    value="{{ old('blocked_address_list', $nas->blocked_addresslist ?? '') }}"
                                                    placeholder="Enter Blocked Address list"
                                                    class="w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20  dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-300 placeholder:text-gray-400 dark:text-zinc-100">
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                <div style="display: flex; align-items: center;">
                                                    <input type="checkbox"
                                                        ...
                                                        name="catch_username" value="1"
                                                        {{ old('catch_username', $nas->catch_username == 1 ? 'checked' : '') }}>
                                                    <label class="block text-sm font-medium text-gray-700"
                                                ...
                                                <select name="default_service_id" id="default_service_id"
                                                    ...
                                                    @foreach ($services as $key => $value)
                                                        <option value="{{ $value->id }}"
                                                            {{ $value->id === $nas->default_s_id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-span-6 sm:col-span-6 catch-username">
                                                ...
                                                <select name="default_operator_id" id="default_operator_id"
                                                    ...
                                                    @foreach ($operators as $key => $value)
                                                        <option value="{{ $value->id }}"
                                                            {{ $value->id === $nas->default_op_id ? 'selected' : '' }}>
                                                            {{ $value->username }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                <div style="display: flex; align-items: center;">
                                                    <input type="checkbox"
                                                        class="mr-2 ckb-password align-middle rounded focus:ring-0 focus:ring-offset-0 dark:bg-zinc-700 dark:border-zinc-400 checked:bg-violet-500 dark:checked:bg-violet-500"
                                                        name="catch_password" value="1"
                                                        {{ old('catch_password', $nas->catch_password == 1 ? 'checked' : '') }}>
                                                    <label class="block text-sm font-medium text-gray-700"
                                                        style="margin-right: 10px;">Catch
                                                        Password</label>
                                                </div>
