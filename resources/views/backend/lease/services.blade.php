...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12 lg:col-span-4">
                                    <div id="external-events">
                                        <div class="mt-4">
                                            ...
                                            <div class="cursor-pointer bg-gray-500/30 px-4 py-2 rounded text-gray-800 mx-2 my-[5px] dark:bg-gray-100 text-[13px]"
                                                data-class="bg-zinc-800">
                                                <i class="align-middle  bx bx-list-ul text-11 ltr:mr-2 rtl:ml-2"></i>Wallet
                                            </div>
                                            <div class="cursor-pointer bg-gray-500/30 px-4 py-2 rounded text-gray-800 mx-2 my-[5px] dark:bg-gray-100 text-[13px]"
                                                data-class="bg-zinc-800">
                                                <i
                                                    class="align-middle  bx bx-list-ul text-11 ltr:mr-2 rtl:ml-2"></i>Statement(s)
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-12 lg:col-span-8">
                                    <form method="POST" action="{{ route('lease.update.services', $user->id) }}"
                                        class="lease-service" id="lease_service" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                name="is_mac"
                                                {{ old('ipv4_mode', $user->userDetail->ipv4_mode) === '1' ? 'checked' : '' }}
                                                value="1">
                                        </div>
    ...
    @include('backend.lease.serviceModal')
@endsection
@section('scripts')
