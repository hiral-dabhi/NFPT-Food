        ...
        <div class="p-4 mx-auto animate-translate sm:max-w-xl">
            <div
                ...
                <div class="bg-white dark:bg-zinc-700">
                    ...
                    <div class="p-5">
                        <form class="add-credit" action="{{ route('lease.credit.add', $user->id) }}" method="POST">
                            @csrf
                ...
                <div class="bg-white dark:bg-zinc-700">
                    ...
                    <div class="p-5">
                        <form class="add-deposit" id="add_deposit"
                            action="{{ route('lease.deposit.add', $user->id) }}" method="POST">
                            @csrf
                            <div class="grid grid-cols-12 ">
                                <div class="col-span-12">
                                    <div class="mb-4 flex flex-row items-center">
            ...
            <div
                ...
                <div class="bg-white dark:bg-zinc-700">
                    ...
                    <div class="p-6 space-y-6 ltr:text-left rtl:text-right">
                        <form action="{{ route('lease.bandwidth.save', $user->id) }}" method="POST"
                ...
                <div class="bg-white dark:bg-zinc-700">
                    ...
                    <div class="p-5">
                        <form class="add-schedule" id="add_schedule"
                            action="{{ route('lease.schedule.add', $user->id) }}" method="POST">
                            @csrf
                            <div class="grid grid-cols-12 ">
                                <div class="col-span-12">
                                    <div class="mb-4 flex flex-row items-center">
