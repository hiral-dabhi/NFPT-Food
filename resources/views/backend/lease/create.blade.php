    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Create Lease" pagetitle="lease" />

                <div class="grid grid-cols-1 mt-3">
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body">
                            <form method="POST" action="{{ route('lease.store') }}" class="lease-create-form"
                                            ...
                                            <div class="mr-2 flex-1">
                                                <select name="ipv4_static_pool" id="ipv4_static_pool"
                                                    ...
                                                    @foreach ($IPv4Static as $key => $value)
                                                        <option value="{{ $key }}"
                                                            {{ old('ipv4_static_pool') == $key ? 'selected' : '' }}>
                                                            {{ $value }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        {{-- <div class="mb-4">
                                            ...
                                            <select name="user_type" id="user_type"
                                                class="w-full rounded placeholder:text-sm py-2 border-gray-100 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60"
                                                value="{{ old('user_type', $user->userDetail->user_type ?? '') }}">
...
@section('scripts')
    ...
    <script>
        ...
        var getIp4s = "{{ route('lease.ipv4.get') }}";
    </script>
    <script>
        $(function() {
            lease.create();
