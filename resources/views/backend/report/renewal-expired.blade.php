    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                <x-page-title title="Renewal / Expired" pagetitle="Reports" />
                                    ...
                                    <div>
                                        <div class="mb-2">
                                            <label for="expired_date"
                                                class="font-medium text-gray-500 form-label text-13 dark:text-zinc-100">Expired
                                                Date</label>
                                        </div>
                                        <input type="text" name="expired_date"
                                            ...
                                            placeholder="Select Expired Date" id="expired_date">
                                    </div>
                                </div>
                                <div class="col-span-12 lg:col-span-3">
                                    <div class="mb-3">
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                            <div class="relative overflow-x-auto card-body">
                                <form action="{{ route('reports.renewal.expired.renew') }}" method="POST"
                                    id="renewal_form">
                                    @csrf
                                    <input type="hidden" name="renewal_ids" id="renewal_ids">
                                    <button type="submit"
                                        class="font-medium mb-4 text-white border-transparent btn bg-violet-500 w-28 hover:bg-violet-700 focus:bg-violet-700 focus:ring focus:ring-violet-50 btn-renewal">Bulk
                                        Renew</button>
                                </form>
                                <table id="reports-renewal-expired-table"
...
@section('scripts')
    ...
    <script>
        var getlist = "{{ route('reports.renewal.expired.fetch') }}";
    </script>
    <script src="{{ asset('js/backend/reports.js') }}"></script>
    <script>
        $(function() {
            reports.renewalExpired();
        });
    </script>
@endsection
